...
export default function ProjectCard({
	...
	return (
		...
		>
			<Card
				className="h-full premium-card group transition-all duration-500 overflow-hidden flex flex-col p-0 rounded-xl shadow-2xl border border-white/10 hover:border-white/20"
				style={{ height: "420px" }}
			>
				{/* Thumbnail */}
				...
				<div className="flex flex-col flex-grow">
					...
					<CardContent className="flex flex-col flex-grow justify-between space-y-3 px-3 pb-3">
						...
						<div className="flex gap-2 mt-auto">
							<Button
								...
								size="sm"
								asChild
								className="flex-1 text-xs border-white/20 text-white/90 hover:bg-white/10 hover:text-white hover:border-white/30 transition-all duration-300"
							>
								<a
									href={github}
									target="_blank"
							...
							<Button
								size="sm"
								asChild
								className="flex-1 text-xs bg-white/90 text-black hover:bg-white hover:text-black transition-all duration-300"
							>
								<a
									href={demo}
									target="_blank"
